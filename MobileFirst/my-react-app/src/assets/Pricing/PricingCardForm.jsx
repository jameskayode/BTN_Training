...
const PricingCardForm = () => {
  return (
<div className="ml-[8rem] mt-[5.25rem] flex flex-col items-start justify-start text-center text-[1rem] text-text-color font-h6 md:text-[2.5rem] md:text-left md:w-[90rem]  mx-auto md:top-[0.81rem] md:ml-[12rem] lg:ml-[25rem] ">
