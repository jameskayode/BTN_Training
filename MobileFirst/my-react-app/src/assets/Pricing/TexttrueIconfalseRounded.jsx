...
const TexttrueIconfalseRounded = ({
  ...
  return (
    <div className="rounded-18xl bg-primary-color  flex flex-col items-center justify-start py-2.5 px-5 text-center text-sm text-light-text-color font-h6  "
      style={{
        backgroundColor: texttrueIconfalseRoundedBackgroundColor,
        padding: texttrueIconfalseRoundedPadding,
        borderRadius: borderRadius,
      }}>
      <b className="relative tracking-[0.2px] leading-[24px]" style={{
        fontSize: h6FontSize,
